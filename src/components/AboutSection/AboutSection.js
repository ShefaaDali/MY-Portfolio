  ...
  return (
    <div className="about-section" id='About'>
      ...
      <div className="AboutText container-fluid">
        ...
        <br></br>
        <br></br>
During my internship at OPTIMIZA, I gained valuable experience in Java SE and OOP concepts, as well as a strong foundation in Java EE, Servlets, JSP, and the use of Tomcat and Netbeans. I also developed my skills in deamling with MySQL Database, and created an employee management website which is available on my GitHub repo.
<br></br>
<br></br>
Also, I learned a lot through  My graduation project (Tawjihi Manageent System Website), which was built using the MERN stack (MongoDB, Express.js, React.js, and Node.js).
<br></br>
<br></br>
Overall, I am a highly skilled and motivated individual with a passion for programming and a strong desire to learn and grow in my field. Fresh graduate computer engineer with a strong academic background, interested in web development, looking for new opportunity to employ and develop my knowledge and skills.
        </p>
      </div>
      <svg className='second-svg'xmlns="http://www.w3.org/2000/svg" viewBox="0 70 1440 200"><path fill="#73566B" fillOpacity="1" d="M0,160L30,181.3C60,203,120,245,180,245.3C240,245,300,203,360,176C420,149,480,139,540,160C600,181,660,235,720,224C780,213,840,139,900,117.3C960,96,1020,128,1080,154.7C1140,181,1200,203,1260,197.3C1320,192,1380,160,1410,144L1440,128L1440,0L1410,0C1380,0,1320,0,1260,0C1200,0,1140,0,1080,0C1020,0,960,0,900,0C840,0,780,0,720,0C660,0,600,0,540,0C480,0,420,0,360,0C300,0,240,0,180,0C120,0,60,0,30,0L0,0Z"></path></svg>
    </div>
  );
}
