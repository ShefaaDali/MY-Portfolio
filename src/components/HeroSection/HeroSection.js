...
function HeroSection() {
  return (
    <div className="hero-section container d-sm-flex pt-5 justify-content-center align-items-center mt-5" id="Home">
      <div className="hero-content pt-5 ">
        <p className="text-center fs-1">Hi, I'm <br></br>
        <span className="fw-bold ">Shefaa Dali </span><br>
        </br> Computer Engineer 
        </p>
        <div className="linkes m-auto lign-items-center">
          <a href="https://www.linkedin.com/in/shefaadali/" ><FontAwesomeIcon icon={faLinkedin} className="linkedin-icon mx-2"/></a>
          <a href="https://github.com/ShefaaDali" ><FontAwesomeIcon icon={faSquareGithub} className="github-icon mx-2" /></a>
          <a href="mailto:shefaadali@gmail.com" className="email-icon"><FontAwesomeIcon icon={faEnvelope} className="email-icon mx-2" /></a>
        </div>
      ...
      <div className="nero-image">
        <img src={computer} alt="" className="Computer-image img-fluid w-60 d-none d-md-block my-auto"/>
      </div>
      </div>
  );
}
